...
<body>
  ...
  <div class="homePageImageCoverContainer">
      <img src="/images/marijuahomepagecover.png" class="img-fluid" width=100%>
  </div>
  
  <!-- What the website do container -->
  <div class="container">
    <h1>What the website do?</h1>
    <div class="row" style="padding-top:30px;">
      <div class="col-md-4">
        <img src="/images/marijuafinderIconSignup.png" width="90px">
        <p style="padding-top:10px;">Sign up or login to the website to buy Marijuana</p>
      </div>
      <div class="col-md-4">
        <img src="/images/marijuafinderIconNearbyUser.png" width="90px">
        <p style="padding-top:10px;">Find a nearby provider or a local store to get your item</p>
      </div>
      <div class="col-md-4">
        <img src="/images/marijuafinderIconBlog.png" width="90px">
        <p style="padding-top:10px;">You can also visit available blogs and discover histories</p>
      </div>
    </div>
  </div>
